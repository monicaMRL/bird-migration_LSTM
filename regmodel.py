...
print("Test")
testresults = hp.evaluatetype1(X_train,y_long_train,y_lat_train,X_test,y_long_test,y_lat_test,models[0],"Path Comparison for Type 1 Cluster "+str(clusterno+1),True)
print(testresults)
...
print("Test")
testresults = hp.evaluatetype2(X_train,y_long_train,y_lat_train,X_test,y_long_test,y_lat_test,models[0],"Path Comparison for Type 2 Cluster "+str(clusterno+1),True)
print(testresults)
